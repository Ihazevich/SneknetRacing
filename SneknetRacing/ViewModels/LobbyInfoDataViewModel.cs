...
namespace SneknetRacing.ViewModels
{
    ...
    {
        private PacketLobbyInfoData _packet = new PacketLobbyInfoData();
        private ConcurrentQueue<byte[]> _receivedRawPackets = new ConcurrentQueue<byte[]>();
        private ConcurrentQueue<PacketLobbyInfoData> _processedPackets = new ConcurrentQueue<PacketLobbyInfoData>();

        public PacketLobbyInfoData Packet
        {
            get
            {
                return _packet;
        ...
        public ConcurrentQueue<PacketLobbyInfoData> ProcessedPackets
        {
            get
            {
        ...
        public void Desserialize()
        {
            ...
            while (true)
            {
                ...
                {
                    Packet = Packet.Desserialize(rawPacket) as PacketLobbyInfoData;

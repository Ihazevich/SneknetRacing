...
namespace SneknetRacing.ViewModels
{
    ...
    {
        private PacketEventData _packet = new PacketEventData();
        private ConcurrentQueue<byte[]> _receivedRawPackets = new ConcurrentQueue<byte[]>();
        private ConcurrentQueue<PacketEventData> _processedPackets = new ConcurrentQueue<PacketEventData>();

        public PacketEventData Packet
        {
            get
            {
                return _packet;
        ...
        public ConcurrentQueue<PacketEventData> ProcessedPackets
        {
            get
            {
        ...
        public void Desserialize()
        {
            ...
            while (true)
            {
                ...
                {
                    Packet = Packet.Desserialize(rawPacket) as PacketEventData;

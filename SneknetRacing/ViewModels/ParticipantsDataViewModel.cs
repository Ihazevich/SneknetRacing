...
namespace SneknetRacing.ViewModels
{
    ...
    {
        private PacketParticipantsData _packet = new PacketParticipantsData();
        private ConcurrentQueue<byte[]> _receivedRawPackets = new ConcurrentQueue<byte[]>();
        private ConcurrentQueue<PacketParticipantsData> _processedPackets = new ConcurrentQueue<PacketParticipantsData>();

        public PacketParticipantsData Packet
        {
            get
            {
                return _packet;
        ...
        public ConcurrentQueue<PacketParticipantsData> ProcessedPackets
        {
            get
            {
        ...
        public void Desserialize()
        {
            ...
            while (true)
            {
                ...
                {
                    Packet = Packet.Desserialize(rawPacket) as PacketParticipantsData;

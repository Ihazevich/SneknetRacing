...
namespace SneknetRacing.ViewModels
{
    ...
    {
        private PacketCarStatusData _packet = new PacketCarStatusData();
        private ConcurrentQueue<byte[]> _receivedRawPackets = new ConcurrentQueue<byte[]>();
        private ConcurrentQueue<PacketCarStatusData> _processedPackets = new ConcurrentQueue<PacketCarStatusData>();

        public PacketCarStatusData Packet
        {
            get
            {
                return _packet;
        ...
        public ConcurrentQueue<PacketCarStatusData> ProcessedPackets
        {
            get
            {
        ...
        public void Desserialize()
        {
            ...
            while (true)
            {
                ...
                {
                    Packet = Packet.Desserialize(rawPacket) as PacketCarStatusData;
